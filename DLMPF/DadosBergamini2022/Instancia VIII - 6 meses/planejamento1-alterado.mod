...
var y{modelos, linhas, periodos}>=0, <=1, binary;
var z{modelos, linhas, periodos}>=0, <=1, binary;
...
sum{i in modelos: MapaModeloRecurso[i,r]==1} demanda[i]<=sum{t in periodos: t>0} ( sum{i in modelos, k in linhas: MapaModeloRecurso[i,r]==1 and MapaLinhaModelo[k,i]==1} 
