...
def main():
    ...
    read_capacidade = pd.read_csv("DadosBergamini2022/Instancia II/capacidade.csv")
    read_demanda = pd.read_csv("DadosBergamini2022/Instancia II/demanda.csv")
    read_itens = pd.read_csv("DadosBergamini2022/Instancia II/modelos.csv")
    read_mapa_modelo_linha = pd.read_csv("DadosBergamini2022/Instancia II/mapalinhamodelo.csv")
    read_mapa_linha_recurso = pd.read_csv("DadosBergamini2022/Instancia II/mapalinharecurso.csv")
    read_mapa_modelo_recurso = pd.read_csv("DadosBergamini2022/Instancia II/mapamodelorecurso.csv")
    read_C = pd.read_csv("DadosBergamini2022/Instancia II/C.csv")
    read_t_processamento = pd.read_csv("DadosBergamini2022/Instancia II/tprocessamento.csv")
    read_capacidade_diaria = pd.read_csv("DadosBergamini2022/Instancia II/capacidadediaria.csv")
